    ...
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookFolder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookFolder_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookFolder_Folder_FolderId",
                        column: x => x.FolderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookFolder_BookId",
                table: "BookFolder",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookFolder_FolderId",
                table: "BookFolder",
                column: "FolderId");
